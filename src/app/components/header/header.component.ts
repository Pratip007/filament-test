...
@Component({
  ...
  template: `
    <header class="border-b border-gray-700 py-3 px-4 lg:px-6 flex items-center justify-between">
      <div class="flex items-center">
        ...
        <h1 class="text-white text-lg font-semibold ml-4">
      ...
      <div class="flex items-center space-x-4">
        ...
        <div class="flex items-center space-x-2">
          <div class="bg-[#171717] h-8 w-8 rounded-full flex items-center justify-center text-sm font-medium">
            DU
          </div>
        </div>
      </div>
